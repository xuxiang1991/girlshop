...
public class Utils {
     ...
     * @return
     */
    public static SpannableString setDifTvColoc(Context context,String showText,int start,int end) {
...
//    }
    ...
    public static boolean isIranOrIraqBySimInfo(Context context) {
        TelephonyManager telManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        String operator = telManager.getSimOperator();
        String imsi = telManager.getSubscriberId();     //获取SIM卡的IMSI码
        String d = telManager.getSimCountryIso();   //返回SIM卡运营商的国家代码
        String dd = telManager.getNetworkOperator();    //返回的MCC +跨国公司的注册网络运营商
        String dsas =telManager.getNetworkCountryIso();     //返回注册的网络运营商的国家代码
        ...
        //466, "Taiwan",  "TW", "台湾"
        if (imsi != null) {
            if (imsi.startsWith("432") || imsi.startsWith("418")) {
                ////伊朗 或者 伊拉克
                is = true;
     ...
     *
     */
    public static int showStars(String le)
    {
        int level=Integer.parseInt(le);
        switch (level)
        {
            case 1:return R.drawable.icon_star01;
            case 2:return R.drawable.icon_star02;
            case 3:return R.drawable.icon_star03;
            case 4:return R.drawable.icon_star04;
            case 5:return R.drawable.icon_star05;
            default:return R.drawable.icon_star05;
...
//dp转化为sp
    ...
    {
        Intent loginIv = new Intent(context, LoginActivity.class);
        context.startActivity(loginIv);
    }
